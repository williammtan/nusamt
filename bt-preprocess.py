...
class Translator:
    def __init__(self, model_path, temperature=0, n_gpus=4):
...
def main(language_directions, output_dir, model_path, url_json_path, max_sentences=100000, min_words=5, valid_size=0.05, test_size=0.05):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid_size', type=float, default=0.05, help="Valid size")
    parser.add_argument('--test_size', type=float, default=0.05, help="Test size")

    args = parser.parse_args()

    main(args.language_directions, args.output_dir, args.model, args.url_json_path, args.max_sentences, args.min_words, args.valid_size, args.test_size)