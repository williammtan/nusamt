...
MODEL_DIR="./data/ban/train/"
OUTPUT_DIR="./data/ban/eval/"
...
# python merge_peft.py -m yellow-AI-NLP/komodo-7b-base -t yellow-AI-NLP/komodo-7b-base -p data/ban/train/ -o data/ban/train-model

# python -m vllm.entrypoints.openai.api_server --model data/ban/train-model --served-model-name nusa-7b-ban --tensor-parallel-size 2 --api-key "6775a246-e9c1-45d4-80f5-bf2af51c2662"