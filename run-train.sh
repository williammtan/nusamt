...
OUTPUT_DIR=${1:-"./data/ban-align/train/"}
...
accelerate launch --main_process_port ${port} --config_file configs/deepspeed_train_config.yaml \
    ...
    --mmt_data_path  data/ban-align/clean/ \
    --use_peft \
    --lora_rank ${LORA_RANK} \
    --do_train \
    --do_eval \
...
bash flores-eval.sh ./data/ban-align/

# MODEL_DIR="./data/ban-align/train/"
# OUTPUT_DIR="./data/ban-align/eval/"
...
# python merge_peft.py -m yellow-AI-NLP/komodo-7b-base -t yellow-AI-NLP/komodo-7b-base -p data/ban-align/train/ -o data/ban-align/train-model

# python -m vllm.entrypoints.openai.api_server --model data/ban-align/train-model --served-model-name nusa-7b-ban --tensor-parallel-size 2 --api-key "6775a246-e9c1-45d4-80f5-bf2af51c2662"